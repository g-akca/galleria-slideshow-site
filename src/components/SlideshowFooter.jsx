...
function SlideshowFooter({ currentIndex, setCurrentIndex, currentData, dataAmount }) {
  return (
    <footer className="fixed bottom-0 w-screen z-50 bg-white py-4 tablet:py-6 px-6 tablet:px-10 flex justify-between items-center border-grey-150 border-t">
      <div className="absolute -top-px left-0 h-px bg-black" style={{ width: `${((currentIndex + 1) / dataAmount) * 100}%` }} />

      <div className="text-black flex flex-col tablet:gap-2">
